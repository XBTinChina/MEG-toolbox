...
elseif length(channel) == 8
    cha = [1:channel(1)-1 channel(1)+1:channel(2)-1 channel(2)+1:channel(3)-1 channel(3)+1:channel(4)-1 channel(4)+1:channel(5)-1 channel(5)+1:channel(6)-1  channel(6)+1:channel(7)-1  channel(7)+1:channel(8)-1  channel(8)+1:157];
elseif length(channel) == 9
    cha = [1:channel(1)-1 channel(1)+1:channel(2)-1 channel(2)+1:channel(3)-1 channel(3)+1:channel(4)-1 channel(4)+1:channel(5)-1 channel(5)+1:channel(6)-1  channel(6)+1:channel(7)-1  channel(7)+1:channel(8)-1  channel(8)+1:channel(9)-1  channel(9)+1:157];
elseif length(channel) == 10
    cha = [1:channel(1)-1 channel(1)+1:channel(2)-1 channel(2)+1:channel(3)-1 channel(3)+1:channel(4)-1 channel(4)+1:channel(5)-1 channel(5)+1:channel(6)-1  channel(6)+1:channel(7)-1  channel(7)+1:channel(8)-1  channel(8)+1:channel(9)-1  channel(9)+1:channel(10)-1  channel(10)+1:157];
